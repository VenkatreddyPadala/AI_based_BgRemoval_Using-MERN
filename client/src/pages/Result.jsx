...
const Result = () => {
  return (
    <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[62.5vh]'>
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex flex-col sm:grid sm:grid-cols-2 gap-8'>
          ...
          <div className='flex flex-col'>
            ...
            <div 
              className='rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden hover:shadow-lg transition-shadow duration-300'
            >
              <img 
              ...
              {/* <div className='absolute right-1/2 bottom-1/2 transform translate-x-1/2 translate-y-1/2'>
                <div 
                  className='border-4 border-violet-600 rounded-full h-12 w-12 border-t-transparent animate-spin'
                ></div>
              </div> */}
            </div>
          </div>
