...
const Header = () => {
  return (
    <div  className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        {/* {Left side} */}
        <div>
            <h1 className='text-4xl xl:text-5xl 2xl:text-6xl font-bold text-neutal-700 leading-tight'>
            ...
            <p className='my-6 text-[15px] text-gray-500'>AI-Powered Background Remover Tool: <br className='max-sm:hidden'/> Effortlessly remove or customize image backgrounds to suit your needs with precision and ease.</p>
            <div>
